  ...
  return (
    <div className="bg-stone-50 font-body">
      ...
      <section className="mx-auto grid max-w-[1100px] items-center gap-12 px-6 pb-16 pt-20 md:grid-cols-2">
        <div>
          ...
          <p className="mt-4 max-w-[440px] text-lg leading-relaxed text-stone-500">
            Stop losing your best prompts in chat history. Save, version, and find any prompt in
            seconds.
          </p>
          <Link
            href="/app"
              ...
              {[
                {
                  ...
                  desc: 'Evaluate candidates against role requirements',
                  tag: 'hiring',
                  time: '2m ago',
                  v: 'v3',
                },
                {
                  ...
                  desc: 'Structured review with security checklist',
                  tag: 'code-review',
                  time: '1d ago',
                  v: 'v7',
                },
                ...
                },
                {
                  ...
                  desc: 'Generate SEO content briefs from topics',
                  tag: 'content',
                  time: '5d ago',
                  v: 'v4',
                },
                ...
                <div
                  key={card.title}
                  className="rounded-lg border border-stone-200 p-2.5 transition-shadow duration-200 hover:shadow-md"
                >
                  <p className="text-xs font-semibold text-stone-900">{card.title}</p>
                  <p className="mt-0.5 text-[10px] text-stone-500">{card.desc}</p>
                  <span className="mt-1.5 inline-block rounded-full bg-primary-light px-1.5 py-0.5 text-[9px] font-medium text-primary">
                    {card.tag}
                  </span>
      ...
      <section className="mx-auto max-w-[1100px] px-6 py-20">
        <h2 className="text-center font-display text-4xl text-stone-900 max-md:text-3xl">
          Sound familiar?
        </h2>
        <p className="mt-2 text-center text-base text-stone-500">
          You&rsquo;ve been here before. We all have.
        </p>
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          {[
            ...
            <div
              key={card.title}
              className="rounded-xl border border-stone-200 bg-white p-7 transition-all duration-200 hover:border-stone-300 hover:shadow-md"
            >
              <div
                className={`mb-4 flex h-10 w-10 items-center justify-center rounded-[10px] ${card.bg} ${card.color}`}
              >
                {card.icon}
              </div>
            ...
            {[
              {
                num: '1',
                title: 'Save',
                body: 'Paste your prompt, add a title and tags. Done in 10 seconds.',
              },
              {
                num: '2',
                title: 'Version',
              ...
              },
              {
                num: '3',
                title: 'Find',
                body: 'Search by any word in your prompt \u2014 title, content, or tags. Instant results.',
              },
            ].map((step) => (
      ...
      <section className="mx-auto max-w-[1100px] px-6 py-20">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          {[
            ...
            <div
              key={f.title}
              className="flex gap-4 rounded-xl border border-stone-200 bg-white p-6 transition-all duration-200 hover:border-stone-300 hover:shadow-md"
            >
      ...
      <section className="bg-gradient-to-b from-stone-50 to-[#F0FDFA] py-20 text-center">
        ...
        <p className="mt-3 text-base text-stone-500">
          Start building your prompt library today. It takes 10 seconds.
        </p>
        <Link
          href="/app"
